...
var app = (function () {
    ...
    // (57:2) {#each categories as category}
    function create_each_block_5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 57, 4, 1150);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(57:2) {#each categories as category}",
    		ctx
    	});
    ...
    function create_each_block_4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", a_class_value = "" + (null_to_empty(/*visited*/ ctx[0][/*i*/ ctx[10]][0] ? "visited" : "") + " svelte-1dqlwzy"));
    			add_location(a, file, 62, 29, 1297);
    			attr_dev(div, "class", "grid-item q svelte-1dqlwzy");
    			add_location(div, file, 62, 4, 1272);
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*visited*/ 1 && a_class_value !== (a_class_value = "" + (null_to_empty(/*visited*/ ctx[0][/*i*/ ctx[10]][0] ? "visited" : "") + " svelte-1dqlwzy"))) {
    ...
    function create_each_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", a_class_value = "" + (null_to_empty(/*visited*/ ctx[0][/*i*/ ctx[10]][1] ? "visited" : "") + " svelte-1dqlwzy"));
    			add_location(a, file, 65, 29, 1493);
    			attr_dev(div, "class", "grid-item q svelte-1dqlwzy");
    			add_location(div, file, 65, 4, 1468);
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*visited*/ 1 && a_class_value !== (a_class_value = "" + (null_to_empty(/*visited*/ ctx[0][/*i*/ ctx[10]][1] ? "visited" : "") + " svelte-1dqlwzy"))) {
    				attr_dev(a, "class", a_class_value);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    function create_each_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", a_class_value = "" + (null_to_empty(/*visited*/ ctx[0][/*i*/ ctx[10]][2] ? "visited" : "") + " svelte-1dqlwzy"));
    			add_location(a, file, 68, 29, 1689);
    			attr_dev(div, "class", "grid-item q svelte-1dqlwzy");
    			add_location(div, file, 68, 4, 1664);
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*visited*/ 1 && a_class_value !== (a_class_value = "" + (null_to_empty(/*visited*/ ctx[0][/*i*/ ctx[10]][2] ? "visited" : "") + " svelte-1dqlwzy"))) {
    				attr_dev(a, "class", a_class_value);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    function create_each_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", a_class_value = "" + (null_to_empty(/*visited*/ ctx[0][/*i*/ ctx[10]][3] ? "visited" : "") + " svelte-1dqlwzy"));
    			add_location(a, file, 71, 29, 1885);
    			attr_dev(div, "class", "grid-item q svelte-1dqlwzy");
    			add_location(div, file, 71, 4, 1860);
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*visited*/ 1 && a_class_value !== (a_class_value = "" + (null_to_empty(/*visited*/ ctx[0][/*i*/ ctx[10]][3] ? "visited" : "") + " svelte-1dqlwzy"))) {
    				attr_dev(a, "class", a_class_value);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(a, "class", a_class_value = "" + (null_to_empty(/*visited*/ ctx[0][/*i*/ ctx[10]][4] ? "visited" : "") + " svelte-1dqlwzy"));
    			add_location(a, file, 74, 29, 2081);
    			attr_dev(div, "class", "grid-item q svelte-1dqlwzy");
    			add_location(div, file, 74, 4, 2056);
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			if (dirty & /*visited*/ 1 && a_class_value !== (a_class_value = "" + (null_to_empty(/*visited*/ ctx[0][/*i*/ ctx[10]][4] ? "visited" : "") + " svelte-1dqlwzy"))) {
    				attr_dev(a, "class", a_class_value);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    function create_fragment(ctx) {
    	...
    	let t4;
    	let div_intro;
    	let each_value_5 = /*categories*/ ctx[1];
    	let each_blocks_5 = [];
    	...
    	let each_value_4 = /*categories*/ ctx[1];
    	let each_blocks_4 = [];
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file, 55, 0, 1074);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*visited, isVisited*/ 5) {
    				each_value_4 = /*categories*/ ctx[1];
    				let i;
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div1, file$2, 13, 4, 349);
    			attr_dev(button, "class", "button-show");
    			add_location(button, file$2, 12, 2, 228);
    			attr_dev(div2, "class", "countdown svelte-chj06u");
    			add_location(div2, file$2, 15, 2, 387);
    			...
    			add_location(source0, file$2, 20, 4, 525);
    			...
    			add_location(source1, file$2, 21, 4, 596);
    			audio.controls = true;
    			audio.autoplay = "autoplay";
    			set_style(audio, "display", "none");
    			add_location(audio, file$2, 19, 1, 458);
    ...
    function create_each_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$3, 22, 8, 506);
    			attr_dev(div0, "class", "img");
    			add_location(div0, file$3, 21, 6, 479);
    			add_location(div1, file$3, 24, 6, 628);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div1, file$3, 18, 2, 365);
    			attr_dev(div2, "class", "blue-container");
    			add_location(div2, file$3, 14, 0, 259);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_then_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 92, 1, 3269);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(img, file$6, 96, 4, 3383);
    			attr_dev(a, "href", "#/");
    			add_location(a, file$6, 95, 3, 3364);
    			attr_dev(div, "class", "home icon-container svelte-e1kjh4");
    			add_location(div, file$6, 94, 2, 3326);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, a);
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$6, 87, 0, 3172);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	async function setStores() {
			...
			`;
    			...
    			if (answers[r][x].indexOf(`https://en.wikipedia.org/wiki/List_of_Olympic_medalists_in_figure_skating`) !== -1) answers[r][x] = "Consult score keepers";
    		}
